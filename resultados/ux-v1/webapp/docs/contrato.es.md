...
c) **Cambios solicitados por EL CLIENTE (zona neutral).** Los cambios solicitados por EL CLIENTE que causen retrasos **no se consideran imputables a ninguna de las Partes** —únicamente extienden los plazos, sin cargo de stand-by—, **salvo** que: (i) impliquen **modificar una sección o ítem ya aprobado** por EL CLIENTE; o (ii) deriven de que **EL CLIENTE haya entregado una sección o tarea por debajo de los estándares** especificados en el Contrato y sus Anexos. En cualquiera de esos dos supuestos, el retraso se considera **imputable a EL CLIENTE** y aplica el cargo de stand-by del inciso (a) (y, tratándose de la modificación de elementos ya aprobados, además el costo de la Cláusula Tercera Bis).
