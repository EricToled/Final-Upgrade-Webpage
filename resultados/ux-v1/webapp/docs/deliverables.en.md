...
**Proposed amount.** The improvement-hours pool is set at **8 hours per month**, monthly and non-rollover. Hours exceeding that pool are billed per the rates agreed with Sports World.
